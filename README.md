...
6.	Envoyer un message via la messagerie intégrée
 ...
 Membres du groupe
- Gedeon ABOTCHI : Frontend
- Ghislaine ALAHOU ADJAHA : Messagerie
- Alex : Backend Flask
- Melahel AKPATA  :Base de données(PostgreSQL et modélisation)
- Marie-Merveille GBAGUIDI : Frontend - Profil Matching
- Amos MONGBO : Backend Flask et Algorithme de matching
- Mahougnon Juste ADJALIAN: README, rapport HTML et déploiement
